...
async function GET(request) {
    try {
        ...
        if (decoded.role?.toLowerCase() !== "admin") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Forbidden"
        }, {
            status: 403
        });
...
async function POST(request) {
    try {
        ...
        const hashed = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(tempPassword, 10);
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.create({
            data: {
                ...
                wilayaId: normalizedRole === "OPERATOR" ? Number(wilaya_id) : null
            },
            include: {
                wilaya: true
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97122216._.js.map